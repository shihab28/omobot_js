...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(ImageViewConfig::AbstractParamDescriptionConstPtr(new ImageViewConfig::ParamDescription<int>("colormap", "int", 0, "colormap", "{'enum_description': 'colormap', 'enum': [{'srcline': 9, 'description': 'NO_COLORMAP', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': -1, 'ctype': 'int', 'type': 'int', 'name': 'NO_COLORMAP'}, {'srcline': 10, 'description': 'COLORMAP_AUTUMN', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'AUTUMN'}, {'srcline': 11, 'description': 'COLORMAP_BONE', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'BONE'}, {'srcline': 12, 'description': 'COLORMAP_JET', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'JET'}, {'srcline': 13, 'description': 'COLORMAP_WINTER', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 3, 'ctype': 'int', 'type': 'int', 'name': 'WINTER'}, {'srcline': 14, 'description': 'COLORMAP_RAINBOW', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 4, 'ctype': 'int', 'type': 'int', 'name': 'RAINBOW'}, {'srcline': 15, 'description': 'COLORMAP_OCEAN', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 5, 'ctype': 'int', 'type': 'int', 'name': 'OCEAN'}, {'srcline': 16, 'description': 'COLORMAP_SUMMER', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 6, 'ctype': 'int', 'type': 'int', 'name': 'SUMMER'}, {'srcline': 17, 'description': 'COLORMAP_SPRING', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 7, 'ctype': 'int', 'type': 'int', 'name': 'SPRING'}, {'srcline': 18, 'description': 'COLORMAP_COOL', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 8, 'ctype': 'int', 'type': 'int', 'name': 'COOL'}, {'srcline': 19, 'description': 'COLORMAP_HSV', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 9, 'ctype': 'int', 'type': 'int', 'name': 'HSV'}, {'srcline': 20, 'description': 'COLORMAP_PINK', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 10, 'ctype': 'int', 'type': 'int', 'name': 'PINK'}, {'srcline': 21, 'description': 'COLORMAP_HOT', 'srcfile': '/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg', 'cconsttype': 'const int', 'value': 11, 'ctype': 'int', 'type': 'int', 'name': 'HOT'}]}", &ImageViewConfig::colormap)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 9 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_NO_COLORMAP = -1;
//#line 10 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_AUTUMN = 0;
//#line 11 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_BONE = 1;
//#line 12 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_JET = 2;
//#line 13 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_WINTER = 3;
//#line 14 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_RAINBOW = 4;
//#line 15 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_OCEAN = 5;
//#line 16 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_SUMMER = 6;
//#line 17 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_SPRING = 7;
//#line 18 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_COOL = 8;
//#line 19 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_HSV = 9;
//#line 20 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
      const int ImageView_PINK = 10;
//#line 21 "/home/shihab/omobot_js/src/image_pipeline/image_view/cfg/ImageView.cfg"
