...
if("TRUE" STREQUAL "TRUE")
  set(compressed_image_transport_SOURCE_PREFIX /home/shihab/omobot_js/src/image_transport_plugins/compressed_image_transport)
  set(compressed_image_transport_DEVEL_PREFIX /home/shihab/omobot_js/devel)
  ...
  set(compressed_image_transport_INSTALL_PREFIX /home/shihab/omobot_js/install)
...
if(NOT "/home/shihab/omobot_js/devel/include;/home/shihab/omobot_js/src/image_transport_plugins/compressed_image_transport/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(compressed_image_transport_INCLUDE_DIRS "")
  set(_include_dirs "/home/shihab/omobot_js/devel/include;/home/shihab/omobot_js/src/image_transport_plugins/compressed_image_transport/include;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'compressed_image_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shihab/omobot_js/src/image_transport_plugins/compressed_image_transport/${idir}'.  ${_report}")
    endif()
    _list_append_unique(compressed_image_transport_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "compressed_image_transport;/usr/local/lib/libopencv_calib3d.so.4.8.0;/usr/local/lib/libopencv_core.so.4.8.0;/usr/local/lib/libopencv_dnn.so.4.8.0;/usr/local/lib/libopencv_features2d.so.4.8.0;/usr/local/lib/libopencv_flann.so.4.8.0;/usr/local/lib/libopencv_gapi.so.4.8.0;/usr/local/lib/libopencv_highgui.so.4.8.0;/usr/local/lib/libopencv_imgcodecs.so.4.8.0;/usr/local/lib/libopencv_imgproc.so.4.8.0;/usr/local/lib/libopencv_ml.so.4.8.0;/usr/local/lib/libopencv_objdetect.so.4.8.0;/usr/local/lib/libopencv_photo.so.4.8.0;/usr/local/lib/libopencv_stitching.so.4.8.0;/usr/local/lib/libopencv_video.so.4.8.0;/usr/local/lib/libopencv_videoio.so.4.8.0")
