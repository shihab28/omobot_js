...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/shihab/omobot_js/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/shihab/omobot_js/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/shihab/omobot_js/install)
...
if(NOT "/home/shihab/omobot_js/devel/include;/home/shihab/omobot_js/src/image_pipeline/image_proc/include;/usr/local/include/opencv4 " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/shihab/omobot_js/devel/include;/home/shihab/omobot_js/src/image_pipeline/image_proc/include;/usr/local/include/opencv4")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shihab/omobot_js/src/image_pipeline/image_proc/${idir}'.  ${_report}")
    endif()
    _list_append_unique(image_proc_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_proc;/usr/local/lib/libopencv_calib3d.so.4.8.0;/usr/local/lib/libopencv_core.so.4.8.0;/usr/local/lib/libopencv_dnn.so.4.8.0;/usr/local/lib/libopencv_features2d.so.4.8.0;/usr/local/lib/libopencv_flann.so.4.8.0;/usr/local/lib/libopencv_gapi.so.4.8.0;/usr/local/lib/libopencv_highgui.so.4.8.0;/usr/local/lib/libopencv_imgcodecs.so.4.8.0;/usr/local/lib/libopencv_imgproc.so.4.8.0;/usr/local/lib/libopencv_ml.so.4.8.0;/usr/local/lib/libopencv_objdetect.so.4.8.0;/usr/local/lib/libopencv_photo.so.4.8.0;/usr/local/lib/libopencv_stitching.so.4.8.0;/usr/local/lib/libopencv_video.so.4.8.0;/usr/local/lib/libopencv_videoio.so.4.8.0")
