...
echo_and_run cd "/home/shihab/omobot_js/src/rqt_image_view"
...
echo_and_run /usr/bin/env \
    ...
    egg_info --egg-base /home/shihab/omobot_js/build/rqt_image_view \
    build --build-base "/home/shihab/omobot_js/build/rqt_image_view" \
    install \
    --root="${DESTDIR-/}" \
